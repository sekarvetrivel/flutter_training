...
class UniLinkPage extends StatefulWidget {
  @override
  _UniLinkPageState createState() => _UniLinkPageState();
}

class _UniLinkPageState extends State<UniLinkPage>
...
List<String>? getCmds() {
  ...
  return [
    ...
    '$cmd "unilinks://goferfamily.trioangledemo.com/$args"$cmdSuffix',
    '$cmd "unilinks://goferfamily.trioangledemo.com/$emojiArgs"$cmdSuffix',
