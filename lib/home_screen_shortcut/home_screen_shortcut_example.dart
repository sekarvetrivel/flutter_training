...
class HomeScreenShortcutPage extends StatefulWidget {
  @override
  _HomeScreenShortcutPageState createState() => _HomeScreenShortcutPageState();
}

class _HomeScreenShortcutPageState extends State<HomeScreenShortcutPage> {
